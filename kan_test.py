...
from KAN_model import ResNetKAN, BasicCNNKAN, ConvNeXtKAN, DenseNetKAN, EfficientNetV2KAN, MobileNetV2KAN, VGG16KAN
...
def main():
    ...
    config = {
        ...
        'results_dir': 'kan_testing_result',
        'models': [
            ...
            {'name': 'mobilenet_kan', 'class': MobileNetV2KAN},
            {'name': 'efficientnetv2_kan', 'class': EfficientNetV2KAN},
            {'name': 'vgg16_kan', 'class': VGG16KAN}
        ]
    }
