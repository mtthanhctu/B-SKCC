...
from FastKAN_model import ResNetFastKAN, BasicCNNFastKAN, ConvNeXtFastKAN, EfficientNetV2FastKAN, DenseNetFastKAN, MobileNetV2FastKAN
...
def main():
    ...
    config = {
        ...
        'results_dir': 'fastkan_training_result',
        'models': [
