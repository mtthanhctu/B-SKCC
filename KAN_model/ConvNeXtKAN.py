...
# Import KANLayer from your KAN file
from version.kan.kan import KANLayer

class ConvNeXtKAN(nn.Module):
    """ConvNeXt + KANLayer implementation"""
    def __init__(self, num_classes=11,  kan_num_grids=5, kan_spline_order=3, pretrained=True):
        ...
        # Get the number of features from ConvNeXt classifier
        num_features = self.convnext.classifier[2].in_features
        
        # Replace the classifier with Identity to get raw features
...
print("Done! ConvNeXt + Regular KAN implementation complete.")