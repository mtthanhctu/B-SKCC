...
from FastKAN_model import ResNetFastKAN, BasicCNNFastKAN, ConvNeXtFastKAN, DenseNetFastKAN, EfficientNetV2FastKAN, MobileNetV2FastKAN, VGG16FastKAN
...
def main():
    ...
    config = {
        'batch_size': 32,
        'checkpoint_dir': 'fastkan_checkpoints',
        'results_dir': 'fastkan_testing_result',
        'models': [
    ...
    if len(test_dataset) == 0:
        raise ValueError(f"No images found in {args.data_zip} for test subset")
